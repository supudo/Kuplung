...
void DialogOptions::showOptionsWindow(ImGuiStyle* ref, DialogStyle* wStyle, bool* p_opened, bool* needsFontChange) {
  ...
  if (ImGui::CollapsingHeader("Rendering")) {
    ImGui::Indent();
    if (ImGui::Checkbox("Terrain Heightmap Image History", &Settings::Instance()->Terrain_HeightmapImageHistory))
      Settings::Instance()->saveSettings();
    if (ImGui::Checkbox("Show Frame Render Time", &Settings::Instance()->showFrameRenderTime))
      Settings::Instance()->saveSettings();

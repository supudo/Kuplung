...
void ExporterOBJ::exportToFile(FBEntity file, std::vector<Model*> faces) {
    this->exportFile = file;
    this->exportGeometry(faces);
    this->exportMaterials(faces);
}

std::string ExporterOBJ::exportMesh(Model *face) {
...
void ExporterOBJ::exportGeometry(std::vector<Model*> faces) {
...
void ExporterOBJ::exportMaterials(std::vector<Model*> faces) {

...
void SaveOpenBinarySeq::init() const {
}

void SaveOpenBinarySeq::saveKuplungFile(const FBEntity& file, std::unique_ptr<ObjectsManager> &managerObjects, const std::vector<ModelFaceBase*>& meshModelFaces) const {
...
const std::vector<ModelFaceData*> SaveOpenBinarySeq::openKuplungFile(const FBEntity& file, std::unique_ptr<ObjectsManager> &managerObjects) const {
...
void SaveOpenBinarySeq::storeObjectsManagerSettings(std::ostream& kuplungFile, std::unique_ptr<ObjectsManager> &managerObjects) const {
...
void SaveOpenBinarySeq::readObjectsManagerSettings(std::istream& kuplungFile, std::unique_ptr<ObjectsManager> &managerObjects) const {
...
void SaveOpenBinarySeq::storeGlobalLights(std::ostream& kuplungFile, std::unique_ptr<ObjectsManager> &managerObjects) const {
...
void SaveOpenBinarySeq::readGlobalLights(std::istream& kuplungFile, std::unique_ptr<ObjectsManager> &managerObjects) const {
...
void SaveOpenBinarySeq::storeObjects(std::ostream& kuplungFile, std::vector<ModelFaceBase*> meshModelFaces) const {
...
const std::vector<ModelFaceData*> SaveOpenBinarySeq::readObjects(std::istream& kuplungFile, std::unique_ptr<ObjectsManager> &managerObjects) const {
  std::vector<ModelFaceData*> models;
...
void SaveOpenBinarySeq::binary_write_model(std::ostream& stream, MeshModel model) const {
...
const MeshModel SaveOpenBinarySeq::binary_read_model(std::istream& stream) const {
  MeshModel model;
...
void SaveOpenBinarySeq::binary_write_model_material_texture(std::ostream& stream, MeshMaterialTextureImage materialTexture) const {
...
const MeshMaterialTextureImage SaveOpenBinarySeq::binary_read_model_material_texture(std::istream& stream) const {
...
const bool SaveOpenBinarySeq::hasEnding(std::string const &fullString, std::string const &ending) const {
...
template<typename T>
const std::ostream& SaveOpenBinarySeq::binary_write(std::ostream& stream, const T& value) const {
  return stream.write(reinterpret_cast<const char*>(&value), sizeof(T));
}

template<typename T>
const std::istream& SaveOpenBinarySeq::binary_read(std::istream& stream, T& value) const {
  return stream.read(reinterpret_cast<char*>(&value), sizeof(T));
}

void SaveOpenBinarySeq::binary_write_string(std::ostream& stream, std::string str) const {
  size_t size = str.size();
  this->binary_write(stream, size);
  stream.write(&str[0], size);
}

const std::string SaveOpenBinarySeq::binary_read_string(std::istream& stream) const {
  std::string str;
  size_t size;

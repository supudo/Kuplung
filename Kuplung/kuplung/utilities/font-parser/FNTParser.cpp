...
const KuplungFontMap FNTParser::parse(FBEntity const& file) {
  this->fm = {};
...
const std::vector<std::string> FNTParser::splitString(const std::string& s, std::regex delimiter) const {

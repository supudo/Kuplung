...
#ifndef ModelFaceDeferredMesh_hpp
#define ModelFaceDeferredMesh_hpp

#include "kuplung/meshes/scene/ModelFace.hpp"

class ModelFaceDeferredMesh: public ModelFace {
public:
...
#endif /* ModelFaceDeferredMesh_hpp */

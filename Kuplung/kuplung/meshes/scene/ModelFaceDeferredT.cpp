...
void ModelFaceDeferredT::render(glm::mat4 matrixProjection, glm::mat4 matrixCamera, glm::mat4 matrixModel, glm::vec3 vecCameraPosition, WorldGrid *grid, glm::vec3 uiAmbientLight) {
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, gBuffer);
        ...
        glm::mat4 projection = this->matrixProjection;
        glm::mat4 view = this->matrixCamera;
        glm::mat4 model;
    ...
    glUniform3fv(glGetUniformLocation(this->shaderProgram_LightingPass, "viewPos"), 1, &this->vecCameraPosition[0]);
    glUniform1i(glGetUniformLocation(this->shaderProgram_LightingPass, "draw_mode"), this->Setting_LightingPass_DrawMode + 1);
    this->renderQuad();

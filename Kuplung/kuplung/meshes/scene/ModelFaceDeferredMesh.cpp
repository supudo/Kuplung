...
#include "ModelFaceDeferredMesh.hpp"
#include <boost/filesystem.hpp>

#define STBI_FAILURE_USERMSG
#include "kuplung/utilities/stb/stb_image.h"

void ModelFaceDeferredMesh::init(MeshModel model, std::string assetsFolder) {
...
void ModelFaceDeferredMesh::renderModel(GLuint shader) {
...
void ModelFaceDeferredMesh::loadTexture(std::string assetsFolder, MeshMaterialTextureImage materialImage, objMaterialImageType type, GLuint* vboObject) {

...
void SpaceshipMeshGenerator::generateFirstHull2() {
  ...
  glm::vec3 norms[] = {glm::vec3(0.0, 0.0, -1.0), glm::vec3(0.0, 0.0, 1.0), glm::vec3(0.0, 1.0, 0.0), glm::vec3(1.0, 0.0, 0.0), glm::vec3(0.0, -1.0, 0.0), glm::vec3(-1.0, 0.0, 0.0)};

  this->indices.push_back(1);
  this->normals.push_back(norms[0]);
  ...
  this->normals.push_back(norms[1]);
  ...
  this->normals.push_back(norms[2]);
  this->indices.push_back(5);
  this->normals.push_back(norms[2]);
  this->indices.push_back(1);
  this->normals.push_back(norms[2]);
  ...
  this->indices.push_back(5);
  this->normals.push_back(norms[3]);
  this->indices.push_back(6);
  this->normals.push_back(norms[3]);
  this->indices.push_back(2);
  this->normals.push_back(norms[3]);
  ...
  this->indices.push_back(2);
  this->normals.push_back(norms[4]);
  this->indices.push_back(6);
  this->normals.push_back(norms[4]);
  this->indices.push_back(7);
  this->normals.push_back(norms[4]);
  ...
  this->normals.push_back(norms[5]);
  this->indices.push_back(3);
  this->normals.push_back(norms[5]);
  this->indices.push_back(7);
  this->normals.push_back(norms[5]);

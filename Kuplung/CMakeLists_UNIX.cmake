...
SET(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -lminizip")
SET(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -lassimp -lstdc++ -lz")
SET(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -llua5.3")
SET(CMAKE_CXX_LINK_FLAGS "${CMAKE_CXX_LINK_FLAGS} -lnoise")

INCLUDE_DIRECTORIES(.)

ADD_DEFINITIONS(-DDef_Kuplung_OpenGL_2x)
...
TARGET_LINK_LIBRARIES(${PROJECT_NAME} "-lminizip")
TARGET_LINK_LIBRARIES(${PROJECT_NAME} "-lassimp -lstdc++ -lz")
TARGET_LINK_LIBRARIES(${PROJECT_NAME} "-llua5.3")
TARGET_LINK_LIBRARIES(${PROJECT_NAME} "-lnoise")

EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_SOURCE_DIR}/resources/" "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/Resources/")
